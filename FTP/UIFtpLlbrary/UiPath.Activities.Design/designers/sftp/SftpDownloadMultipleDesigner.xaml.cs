...
{
	public partial class SftpDownloadMultipleDesigner : ActivityDesigner, IComponentConnector
	{
        ...
        public SftpDownloadMultipleDesigner()
		{
		...
		private void LoadButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (modelitemparent.Properties != null)  
            {
                //System.Windows.Forms.MessageBox.Show("Container");
