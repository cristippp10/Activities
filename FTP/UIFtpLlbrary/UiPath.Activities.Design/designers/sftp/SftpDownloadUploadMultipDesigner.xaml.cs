...
{
	public partial class SftpDownloadUploadMultipDesigner : ActivityDesigner, IComponentConnector
	{
        ...
        public SftpDownloadUploadMultipDesigner ()
		{
		...
		private void LoadButton_Click(object sender, RoutedEventArgs e)
		{
            ...
            if (modelitemparentup.Parent != null)
                if (modelitemparent.Parent != null)
                    if (modelitemparent.Properties != null)  
            {
                //System.Windows.Forms.MessageBox.Show("1 " + modelitemparentup.ItemType);
            ...
            if (modelitemparentup.Parent == null)
            {
                //System.Windows.Forms.MessageBox.Show("2 " + modelitemparentup.ItemType);
