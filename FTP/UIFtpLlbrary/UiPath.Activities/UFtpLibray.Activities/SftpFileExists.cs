...
namespace FtpActivities
{
    ...
    public class SftpFileExists : BaseActivity
    {
        ...
        [Category("Output")]
        public OutArgument<bool> FileExists
        {
            get;
            set;
        }
        [Category("Output")]
        public OutArgument<FtpFileClass> FileAttributes
        {
            get;
            set;
        }
        ...
        protected override void CacheMetadata(NativeActivityMetadata metadata)
        {
            ...
            metadata.AddArgument(new RuntimeArgument("FileExists", typeof(bool), ArgumentDirection.Out));
            metadata.AddArgument(new RuntimeArgument("FileAttributes", typeof(FtpFileClass), ArgumentDirection.Out));
        ...
        protected override void ExecuteAsync()
        {
            try
            {
               ...
               {
                   FileExists.Set(true);
                   FileAttributes.Set(sessiongen.GetFileAttributes(remotepath));
               }
               else
