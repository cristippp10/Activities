...
namespace FtpActivities
{
    ...
    [Designer(typeof(SftpCreateDirDesigner))]
    public class SftpCreateDir : BaseActivity
    {
        ...
        [Category("Input")]
        public InArgument<string> NewDirName 
        {
            get;
            set;
        }
        ...
        protected override void CacheMetadata(NativeActivityMetadata metadata)
        {
            ...
            metadata.AddArgument(new RuntimeArgument("NewDirName", typeof(string), ArgumentDirection.In, true));
        ...
        protected override void ExecuteAsync()
        {
            try
            {
               ...
               string newdirname = NewDirName.Get<string>();
               string newdir = (remotepath != "") ? remotepath + "/" + newdirname : newdirname;
               if (!sessiongen.RemoteDirectoryExists(newdir))
               {
                   sessiongen.CreateDirectory(newdir);
               }
