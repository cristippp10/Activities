...
namespace FtpActivities
{
    ...
    public class SftpListFilesDirSubDir : BaseActivity
    {
                ...
                if (remotepath.Contains("|"))
                {
                    ...
                    foreach (string rpath in paths)
                    {
                        if (rpath.Length > 1)
                        {
                            ...
                            {
                                sessiongen.GetFilesAllSubDir(rpath, ref listFiles);
                            }
                        }
                    }
                }
                    ...
                    {
                        sessiongen.GetFilesAllSubDir(remotepath, ref listFiles);
                    }
