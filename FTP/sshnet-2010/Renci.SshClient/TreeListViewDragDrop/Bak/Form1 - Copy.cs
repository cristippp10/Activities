...
namespace TreeListViewDragDrop {
    public partial class Form1 : Form {
        ...
        public Form1()
        {
            ...
            ////sftpTest.Sftp_BeginSynchronizeDirectories(sftpClient, @"G:\Bak\BooksIT", "Documents", "*.*");
            //sftpTest.Sftp_BeginSynchronizeDirectories(sftpClient, @"G:\Bak\Stream", "Documents", "*.*");
        ...
        public Renci.SshNet.SftpClient sftpClient;
        private void Form1_Load(object sender, EventArgs e) {
            ...
            olvColumn1.ImageGetter = delegate(object x) { return "folder"; };
            ...
            //LocalPathRoot = @"G:\Bak";
            treeListView1.Roots = ModelWithChildren.CreateModels(null, new ArrayList { "" }, sftpClient, LocalPathRoot);
            treeListView2.Roots = ModelWithChildren.CreateModels(null, new ArrayList { "" }, sftpClient, LocalPathRoot, 1);
        ...
        private void MoveObjectsToChildren(TreeListView targetTree, TreeListView sourceTree, ModelWithChildren target, IList toMove) {
            foreach (ModelWithChildren x in toMove) {
                ...
                {
                    if (y.Update == "file")
                        sftpClient.UploadFile(File.OpenRead(y.LocalPath), (target.RemotePath == "") ? target.RemotePath + y.Label : target.RemotePath + @"/" + y.Label);
                    //sftpClient.DownloadFile(y.RemotePath, File.Create(target.RemotePath+ "\\" + y.Label));
                    if (y.Update == "dir")
                    {
                        Renci.SshNet.Tests.Classes.SftpClientTest sftpTest = new Renci.SshNet.Tests.Classes.SftpClientTest();
                        //sftpTest.Sftp_Multiple_Async_Download_Files(sftpClient, @"G:\TestDownload", "Documents", "*.*");
    ...
    public class ModelWithChildren {
        ...
        public static Renci.SshNet.SftpClient sftpClient;
        ...
        public List<ModelWithChildren> Children {
            get {
                ...
                if (this.children == null)
                    children = CreateModels(this, this.DataForChildren, sftpClient, LocalPathRoot, LocalRemote );
        ...
        //}
        public static List<ModelWithChildren> CreateModels(ModelWithChildren parent, ArrayList data, Renci.SshNet.SftpClient sftp, string localPathRoot, int localRemote = 0) {
            ...
            else
            {
                ...
                if (parent.LocalRemote == 0)
                {
                    var files = sftpClient.ListDirectory(pathremote);
